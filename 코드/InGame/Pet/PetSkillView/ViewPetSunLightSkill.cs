...
namespace BlackTree
{
    public class ViewPetSunLightSkill : MonoBehaviour
    {
        ...
        ControllerPetUnitInGame unit;
        public void Activate(ControllerPetUnitInGame _unit)
        {
            ...
            unit = _unit;
            petCache = _unit.petCache;


            this.transform.position = unit._view.transform.position;
        ...
        private void FixedUpdate()
        {
            ...
            //endLaser 이동
            endLaserBeam.transform.RotateAround(startLaserBeam.transform.position, Vector3.back, Time.deltaTime * 40 );
